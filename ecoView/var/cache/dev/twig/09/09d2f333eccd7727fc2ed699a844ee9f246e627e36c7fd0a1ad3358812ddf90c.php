...
class __TwigTemplate_2a92e5c79c88636e16236a321acd2ecb45dbda750dda60ab138e965180c227b3 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
       ...
       <form id=\"formulaire\">";
        ...
        echo "
            ...
            <div>";
        // line 15
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 15, $this->source); })()), "user_email", [], "any", false, false, false, 15), 'row');
        echo "</div>
            <div>";
        // line 16
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 16, $this->source); })()), "user_name", [], "any", false, false, false, 16), 'row');
        echo "</div>
            <div>";
        // line 17
...
";
    ...
    {
        return array (  163 => 25,  151 => 22,  145 => 19,  142 => 18,  140 => 17,  136 => 16,  132 => 15,  127 => 13,  123 => 11,  114 => 9,  109 => 8,  99 => 7,  80 => 5,  61 => 3,  38 => 1,);
    }
...
{% block styles %}{{ encore_entry_link_tags('register') }}{% endblock %}
...
{% block body %}
    ...
    {% endfor %}
       ...
       <form id=\"formulaire\">{{ form_start(registrationForm) }}
            <h1 id=\"H1\">Register</h1>
            <div>{{ form_row(registrationForm.user_email) }}</div>
            <div>{{ form_row(registrationForm.user_name) }}</div>
