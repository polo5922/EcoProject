...
class getSecurity_AccessMapService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/user/add_asoc'), [0 => 'ROLE_ADMIN', 1 => 'ROLE_USER', 2 => 'ROLE_ASSOC'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/user/show'), [0 => 'ROLE_ADMIN', 1 => 'ROLE_USER', 2 => 'ROLE_ASSOC'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/user/edit'), [0 => 'ROLE_ADMIN', 1 => 'ROLE_USER', 2 => 'ROLE_ASSOC'], NULL);
